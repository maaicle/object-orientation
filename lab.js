...
//Code here
favoriteThings.car = 'dump truck';
favoriteThings.show = 'TWD';
...
// console.log(ingredients(burger));
...
let cocoa = new Cat('Cocoa', 8, 'black');
...
let wizard1 = new Wizard('Mentos', 43, 'freshen breath')
...
//Code Here
let phone1 = new Phone('Motorolla', 'Razer', 10, 'black', 200);
let phone2 = new Phone('T-Mobile', 'Sidekick', 15, 'white', 300);
let phone3 = new Phone('Nokia', 'Brick', 1, 'gray', 50);
...
//Code Here
let myFirstVehicle = new Vehicle(4, 'teal', 150000);
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(1, 'black', 100, 'Triumph', true);
...
//Code Here
let myFirstBoat = new Boat(10, 'purple', 3000, 'Root Beer Float', 'speed boat', false);
